(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es6.regexp.replace'), require('core-js/modules/es6.regexp.split'), require('core-js/modules/es6.regexp.search'), require('core-js/modules/es6.regexp.match'), require('core-js/modules/es6.regexp.constructor'), require('core-js/modules/es6.promise'), require('core-js/modules/es6.object.to-string'), require('core-js/modules/es6.typed.uint8-array'), require('core-js/modules/es6.function.name')) :
  typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es6.regexp.replace', 'core-js/modules/es6.regexp.split', 'core-js/modules/es6.regexp.search', 'core-js/modules/es6.regexp.match', 'core-js/modules/es6.regexp.constructor', 'core-js/modules/es6.promise', 'core-js/modules/es6.object.to-string', 'core-js/modules/es6.typed.uint8-array', 'core-js/modules/es6.function.name'], factory) :
